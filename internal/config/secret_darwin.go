...
func (keychainStore) Get(service, account string) (string, error) {
	// #nosec G204 -- security is a fixed executable; service/account are passed as argv, not through a shell.
...
func (keychainStore) Set(service, account, secret string) error {
	// #nosec G204 -- security is a fixed executable; user token is passed as argv, not through a shell.
